                	...
                	<div class="textwidget">
                    	<ul class="address">
							<li>
								...
								<h4>Address:</h4>
                                <p>No.50A St. Leonard Street, Hendon, 
                                Sunderland,  UK</p>
							</li>
                            <li>
                        ...
                        <div class="socialicons">
                            ...
                            <a href="https://x.com/kafinixventures"><i class="fa fa-twitter"></i></a>
        ...
        <div class="footerbottom">
        	<div class="row">
            	<div class="medium-6 small-12 columns">
                    ...
                    <div class="copyrightinfo">2025 © <a href="{{route('shop')}}">Kafinix Ventures Ltd</a> All Rights Reserved.</div>
                </div><!--left side-->
   ...
   <!-- Webful JS -->
   <script src="{{asset('assets/js/webful.js')}}"></script> 